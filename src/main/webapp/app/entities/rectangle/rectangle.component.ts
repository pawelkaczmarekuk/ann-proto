...
export class RectangleComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.rectangleService
            ...
            .subscribe(
                (res: HttpResponse<IRectangle[]>) => this.paginateRectangles(res.body, res.headers),
    ...
    trackId(index: number, item: IRectangle) {
        return item.id;
    }
    ...
    private paginateRectangles(data: IRectangle[], headers: HttpHeaders) {
