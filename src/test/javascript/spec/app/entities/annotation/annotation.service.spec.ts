    ...
    describe('Annotation Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/annotations';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Annotation', () => {
                service.create(new Annotation(null)).subscribe(received => {
            ...
            it('should update a Annotation', () => {
                service.update(new Annotation(123)).subscribe(received => {
