...
import { AnnotationSetComponent } from 'app/entities/annotation-set/annotation-set.component';
...
describe('Component Tests', () => {
    describe('AnnotationSet Management Component', () => {
        let comp: AnnotationSetComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AnnotationSetComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.annotationSets[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
